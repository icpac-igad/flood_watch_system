...
export const getTableData = createSelector(
  ...
  (interaction = {}) => {
    ...
    // Include all fields (including hidden ones for chart data)
    // The DataTable component will handle visibility
    return (
      interactionConfig &&
      ...
      interactionConfig.output
        .map((c) => ({
          ...c,
          label: c.property,
          value: c.intersection
            ? intersectionMap[data[c.column]]
            : data[c.column],
        }))
    );
  }
