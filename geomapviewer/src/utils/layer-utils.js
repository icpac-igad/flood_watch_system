...
const BACKEND_FILTER_PARAMS = ['country_name', 'region_name', 'district_name', 'whca_countries', 'admin_level'];
...
const WHCA_TILE_REPLACEMENTS = {
  // Multimodal forecast points - use WHCA filtered function
  'public.multimodal_points': { replacement: 'public.multimodal_points_whca' },
  // Multimodal clustered points - use WHCA filtered clustered function
  'public.multimodal_points_clustered': { replacement: 'public.multimodal_points_clustered_whca' },
...
const ADMIN_TILE_REPLACEMENTS = {
  ...
  'public.multimodal_points': { replacement: 'public.multimodal_points_by_admin' },
  'public.multimodal_points_clustered': { replacement: 'public.multimodal_points_by_admin' },
