...
from geomanager.blocks import NavigationItemsBlock, FilterTypeBlock
...
class GeomanagerSettings(BaseSiteSetting, ClusterableModel):
    ...
    filter_types = StreamField(
        [("filter_type", FilterTypeBlock())],
        use_json_field=True,
        null=True,
        blank=True,
        verbose_name=_("Filter Types"),
        help_text=_("Define filter types shown in the map viewer. Order = dropdown order."),
    )
    ...
    edit_handler = TabbedInterface(
        [
            ...
            ObjectList(
                [FieldPanel("filter_types")],
                heading=_("Filter Settings"),
            ),
        ]
    )
