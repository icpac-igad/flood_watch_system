...
const nextConfig = {
  ...
  env: {
    ...
    DEFAULT_CENTER_LAT: process.env.DEFAULT_CENTER_LAT,
    DEFAULT_CENTER_LNG: process.env.DEFAULT_CENTER_LNG,
    DEFAULT_ZOOM_LEVEL: process.env.DEFAULT_ZOOM_LEVEL,
    DEFAULT_MIN_ZOOM: process.env.DEFAULT_MIN_ZOOM
  },
};
