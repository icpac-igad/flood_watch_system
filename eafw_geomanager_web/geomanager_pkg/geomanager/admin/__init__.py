...
from geomanager.admin.watcher_config import WatcherConfigModelAdmin, urls as watcher_config_urls
from geomanager.admin.wms import WmsLayerModelAdmin, urls as wms_urls
from geomanager.admin.dataset_sync import WmsRasterSyncAdmin
