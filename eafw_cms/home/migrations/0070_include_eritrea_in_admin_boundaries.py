...
FORWARD_SQL = """
-- Remove Eritrea exclusions from all admin boundary functions.
-- Eritrea geometry has been re-imported from GADM and should be included.

-- 1) refresh_admin_extent_cache — remove Eritrea exclusion
...
-- 2) resolve_admin_extent_geom — remove Eritrea exclusion
...
-- 3) get_admin_clip_geom — remove Eritrea exclusion
...
-- 4) list_admin_names — remove Eritrea exclusion
...
-- 5) resolve_scope_extent_geom — remove Eritrea exclusion from project_countries branch
...
-- Refresh the admin extent cache to include Eritrea
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("home", "0069_whca_extent_use_country_union"),
    ]
