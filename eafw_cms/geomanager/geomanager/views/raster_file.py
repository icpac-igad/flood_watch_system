...
def upload_raster_file(request, dataset_id=None, layer_id=None):
    ...
    layer_upload_url = reverse("geomanager_dataset_upload_raster", args=[dataset.pk])
    layer_list_url = None
    ...
    if layer_id:
        ...
        layer_upload_url = reverse("geomanager_dataset_layer_upload_raster", args=[dataset.pk, layer.pk])
    ...
    context.update(
        {
            ...
            "simple_upload_url": reverse("geomanager_dataset_upload_raster", args=[dataset.pk]),
