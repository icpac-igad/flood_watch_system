...
# Stub view for disabled adminboundarymanager tiles endpoint
# The AdminBoundarySettings model tries to reverse 'admin_boundary_tiles' URL
# but we disabled the adminboundarymanager.urls because the table was removed.
# This stub allows the URL to be reversed without actually serving tiles.
class AdminBoundaryTilesStubView(View):
    """Stub view that returns empty MVT tile - adminboundary table was removed"""
...
urlpatterns = [
    ...
    # Stub URL for admin_boundary_tiles - the adminboundarymanager_adminboundary table
    # was removed in migration 0006, but AdminBoundarySettings.boundary_tiles_url
    # tries to reverse this URL name. This stub allows the reverse() to work.
    path(
        r'api/admin-boundary/tiles/<int:z>/<int:x>/<int:y>',
        AdminBoundaryTilesStubView.as_view(),
        name="admin_boundary_tiles"
    ),
    # Note: Full adminboundarymanager.urls disabled - we use stub above for URL reversal only
